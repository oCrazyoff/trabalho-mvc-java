...
<t:layout titulo="Gêneros - Lumina">
        ...
        <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-2 text-gray-500">
                    Consulte, cadastre e gerencie as categorias da biblioteca.
                </p>
            </div>

            <a href="${pageContext.request.contextPath}/admin/generos?acao=novo"
    ...
    <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
        <div class="border-b border-gray-100 px-5 py-4 sm:px-6">
            <h2 class="font-semibold text-gray-900">Categorias cadastradas</h2>
        </div>
                    ...
                    <table class="w-full min-w-[640px] divide-y divide-gray-100 text-left">
                        <thead class="bg-gray-50">
                            <tr class="text-xs font-semibold uppercase tracking-wider text-gray-500">
                                <th scope="col" class="px-5 py-4">Gênero</th>
                                <th scope="col" class="px-5 py-4">Descrição</th>
                            ...
                            <c:forEach var="g" items="${generos}">
                                <tr class="transition hover:bg-gray-50/70">
                                    ...
                                    <td class="px-5 py-4 text-sm text-gray-500">
                                        <c:out value="${not empty g.descricao ? g.descricao : '-'}"/>
                                    </td>
                                    <td class="px-5 py-4 text-right">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="${pageContext.request.contextPath}/admin/generos?acao=editar&id=${g.id}"
                                        ...
                                        <a href="${pageContext.request.contextPath}/admin/generos?acao=excluir&id=${g.id}"
                                        onclick="return confirm('Deseja excluir o gênero ${g.nome}?')"
